...
# parse $1
$JAVA -Xmx60g -cp lib/anna-3.3.jar:$STANFORD:pathlstm.jar se.lth.cs.srl.CompletePipeline eng -lemma $LEMMA_MODEL -parser $PARSER_MODEL -tagger $POS_MODEL -srl $SRL_MODEL $RERANKER $TOKENIZE -test $1
